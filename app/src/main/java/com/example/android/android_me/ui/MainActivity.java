...
public class MainActivity extends AppCompatActivity implements MasterListFragment.OnImageClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO/COMLETED (4) If you are making a two-pane display, add new BodyPartFragments to create an initial Android-Me image
        // Also, for the two-pane display, get rid of the "Next" button in the master list fragment
        if (findViewById(R.id.android_me_linear_layout) != null) {
            // This LinearLayout will only initially exist in the two-pane tablet case
            mTwoPane = true;

            // Getting rid of the "Next" button that appears on phones for launching a se
            ...
            if (savedInstanceState == null) {
                // In two-pane mode, add initial BodyPartFragements to the screen
                FragmentManager fragmentManager = getSupportFragmentManager();

                // Creating a new head fragment
                BodyPartFragment headFragment = new BodyPartFragment();
                headFragment.setImageIds(AndroidImageAssets.getHeads());
                // Add the fragement to its container using a transaction
    ...
    public void onImageSelected(int position) {
        ...
        if (mTwoPane) {
            ...
            // Set the currently displayed item for the correct body part fragement
            switch (bodyPartNumber) {
                ...
                case 1:
                    ...
                    // Give the corrent image resource to the new fragement
                    newFragment.setImageIds(AndroidImageAssets.getBodies());
                    newFragment.setListIndex(listIndex);
                    //Replace the old body fragement with anew one
                    getSupportFragmentManager().beginTransaction()
                ...
                case 2:
                    ...
                    // Give the correct image resource to the new fragement
