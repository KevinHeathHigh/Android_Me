...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    // TODO/COMPLETED (1) Create a layout file that displays one body part image named fragment_body_part.xml
    // This layout should contain a single ImageView

    // TODO/COMPLETED (2) Create a new class called BodyPartFragment to display an image of an Android-Me body part
    // In this class, you'll need to implement an empty constructor and the onCreateView method
    // TODO/COMPLETED (3) Show the first image in the list of head images
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO/COMPLETED (5) Create a new BodyPartFragment instance and display it using the FragmentManager
